...
func _ready():
	...
	upgrades_container = get_parent().get_parent().get_parent().get_node("Control/StoreManagementMenu/ManagementMenu/StoreManagementContainer/StoreUpgradesContainer")
	expenses_container = get_parent().get_parent().get_parent().get_node("Control/StoreManagementMenu/ManagementMenu/StoreManagementContainer/ExpensesContainer")
	parent_margin_container = get_parent().get_parent().get_parent().get_node("Control/StoreManagementMenu")
	exit_button = get_parent().get_parent().get_parent().get_node("Control/StoreManagementMenu/ManagementMenu/StoreManagementContainer/StoreManagementExitButton")
